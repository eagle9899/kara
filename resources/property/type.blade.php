...
<div class="col-md-6 p-5 mt-lg-5">
    <h1 class="display-5 animated fadeIn mb-4">{{ $propertynames->property }}</h1>
    <nav aria-label="breadcrumb animated fadeIn">
        <ol class="breadcrumb text-uppercase">
            <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
            <li class="breadcrumb-item"><a href="{{ route('property') }}">Property Types</a></li>
            <li class="breadcrumb-item text-body active" aria-current="page">{{ $propertynames->property }}</li>
        </ol>
    </nav>
</div>
@endsection
                    ...
                    <div class="property-item rounded overflow-hidden">
                            ...
                            <div id="carouselExampleInterval{{ $item->id }}" class="carousel slide"
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item {{ $loop->first ?'active' :'' }}"
                                        ...
                                        <a
                                            href="{{ route('property-single',$propertynames->property.'/'.$item->slug) }}">
                        ...
                        <div class="p-4 pb-0">
                            ...
                            <a class="d-block h5 mb-2 text-capitalize post-short-title"
                                href="{{ route('property-single',$propertynames->property.'/'.$item->slug) }}">{{ substr($item->title, 0, 28,) }}
                                ...</a>
