    ...
    <div class="container">
        ...
        <div>
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="property-item rounded overflow-hidden">
                        ...
                        <div class="p-4 pb-0">
                            <h5 class="text-primary mb-3 text-uppercase">{{ $item->currency }} {{ $item->rate }}</h5>
                    ...
                    <div class="container text-center">
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                ...
                                <h1 class="mb-4">There is no data to Display</h1>
                                <p class="mb-4">We’re sorry, the data you have looked for does not exist in our website!
            ...
            <div class="row g-4 justify-content-center mt-3">
                <div class="col-lg-6">
                    <div class="justify-content-cventer">{{ $house->links() }}</div>
