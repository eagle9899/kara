...
$meta_keywords = $post->title . ','. $post->city .','. $post->sub_category. ','. $post->rCategory->name ;
$desc = '';

$meta_desc = $post->title . ','. $post->city .','. $post->sub_category .','. $post->rCategory->name ;
$title = $meta_title;
@endphp
...
<div class="col-md-6 p-5 mt-lg-5">
    <h1 class="display-5 animated fadeIn mb-4">{{ $post->rCategory->name }}</h1>
    <nav aria-label="breadcrumb animated fadeIn">
        <ol class="breadcrumb text-uppercase">
            <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
            <li class="breadcrumb-item"> <a href="{{ route('category',$post->rCategory->slugs) }}">
                    {{ $post->rCategory->name }}</a></li>
                    ...
                    <div class="property-item rounded overflow-hidden">
                        ...
                        <div class="p-4 pb-0">
                            ...
                            <a class="d-block h5 mb-2 text-capitalize"
                                href="{{ route('category_by_subcategory_detail',$item->rCategory->slugs .'/'. $item->rSubcategory->slug .'/'.$item->slug) }}">{{ $item->title }}</a>
