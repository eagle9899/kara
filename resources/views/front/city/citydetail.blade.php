@php
$meta_title = $city->city .','. $subcategory->sub_category. ','.$category->name;
$meta_keywords = $city->city .','. $subcategory->sub_category. ','.$category->name;
$desc = '';
if (count($post)){
...
$meta_desc =$desc. $city->city .','. $subcategory->sub_category. ','.$category->name;
$title = $city->city .' | '. $subcategory->sub_category. ' | '.$category->name;;
@endphp
                    ...
                    <div class="property-item rounded overflow-hidden">
                            ...
                            <div id="carouselExampleInterval{{ $item->id }}" class="carousel slide"
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item {{ $loop->first ?'active' :'' }}"
                                        ...
                                        <a
                                            href="{{ route('city_single_post',$item->city.'/'.$item->rSubcategory->slug.'/'.$item->slug) }}">
                        ...
                        <div class="p-4 pb-0">
                            ...
                            <a class="d-block h5 mb-2 text-capitalize post-short-title"
                                href="{{ route('city_single_post',$item->city.'/'.$item->rSubcategory->slug.'/'.$item->slug) }}">{{ substr($item->title, 0, 28,) }}
                                ...</a>
