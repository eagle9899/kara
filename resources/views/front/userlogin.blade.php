        ...
        <div class="row g-4">
            ...
            <div class="col-md-6">
                <div class="wow fadeInUp" data-wow-delay="0.5s">
                    <form method="post" action="{{ route('user_login_submit') }}" class="form_userlogin_ajax">
                        @csrf
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    ...
                                    <span
                                        class="text-danger error-text email_error @error('email') is-invalid @enderror"></span>
                            ...
                            <div class="col-12">
                                <a class="" href="{{ route('user_forget_password') }}">Forget password?</a>
                            </div>
...
<div id="" class="col-md-4 col-12">
    <button class="btn btn-outline-danger btn-lg btn-block">Invalid</button>
</div>
@endif
