...
<div class="col-md-6 p-5 mt-lg-5">
    <h1 class="display-5 animated fadeIn mb-4">Home</h1>
    <nav aria-label="breadcrumb animated fadeIn">
        <ol class="breadcrumb text-uppercase">
            <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
            <li class="breadcrumb-item text-body active" aria-current="page">Home detail</li>
            </li>
        </ol>
    </nav>
</div>
                ...
                <div class="pt-5">
                    ...
                    <div class="p-4 property-item rounded overflow-hidden">
                        ...
                        <div class="col-lg-12 ">
                            ...
                            <hr>
                            <div class="ps-3">
                                <form class="row g-3" action="route('enquired_property_data')">
                    ...
                    <div class="property-item rounded overflow-hidden">
                        ...
                        <div class="p-4 pb-0">
                            ...
                            <a class="d-block h5 mb-2 text-capitalize"
                                href="{{ route('homedetails',$item->slug) }}">{{ $item->title }}</a>
