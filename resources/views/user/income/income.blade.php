                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-primary" type="button" data-bs-toggle="modal"
                                            data-bs-target="#modalincomeedit"><i class="ri ri-edit-line"></i></button>

                                    </td>

                                    <div class="modal fade" id="modalincomeedit" data-bs-backdrop="false"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <form action="{{ route('user_income_update',$income->id ) }}"
                                                            method="post">
                                                            @csrf
                                                            <div class="row my-3">
    ...
    <div class="modal fade" id="modalincome" data-bs-backdrop="false" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <form action="{{ route('user_income_store') }}" method="POST">
                            @csrf
                            <div class="row my-3">
                                <div class="col-12 mb-2">
